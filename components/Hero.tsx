...
<section id="hero" data-w="hero">
  ...
  <div className="hx">
    ...
    <p className="hx-sub ea">Every visit, this site deals you one of seven design worlds — typography, color, motion, even the cursor. Scroll to walk all of them. The work changes register; <b>the standard doesn't.</b></p>
    ...
    <div className="hx-actions ea">
      ...
      <span className="hx-hint">OR SCROLL — ALL SEVEN ARE DOWN THERE</span>
    </div>
  </div>
